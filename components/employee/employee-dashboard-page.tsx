    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      <div className="space-y-8 p-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-6">
                <div className="relative">
                  <div className="w-20 h-20 bg-gradient-primary rounded-full flex items-center justify-center text-white text-2xl font-bold animate-pulse-glow">
                ...
                <div>
                  ...
                  <p className="text-2xl font-mono text-blue-600 mt-2 animate-pulse">
          ...
          <Card className="card-interactive animate-scale-in stagger-2 hover-glow">
            <CardContent className="p-6">
              ...
              <div className="mt-4">
                ...
                <p className="text-xs text-gray-500 mt-1">Target: 40 hours</p>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Quick Actions */}
          <Card className="lg:col-span-1 animate-slide-in-left card-glow">
            <CardHeader>
          ...
          <Card className="lg:col-span-2 animate-slide-in-right card-glow">
            ...
            <CardContent>
              <div className="space-y-4">
                {stats?.checkInTime && (
                  <div className="flex items-start space-x-4 p-4 bg-green-50 rounded-lg hover-scale">
                    <div className="p-2 bg-green-100 rounded-full">
                      <CheckCircle className="h-4 w-4 text-green-600" />
                    </div>
                    <div className="flex-1">
                      <p className="font-medium text-green-800">Checked in successfully</p>
                      <p className="text-sm text-green-600">Today at {stats.checkInTime}</p>
                    </div>
                  </div>
                )}
                
                <div className="flex items-start space-x-4 p-4 bg-blue-50 rounded-lg hover-scale">
                ...
                <div className="flex items-start space-x-4 p-4 bg-purple-50 rounded-lg hover-scale">
                  <div className="p-2 bg-purple-100 rounded-full">
                    <Award className="h-4 w-4 text-purple-600" />
                  </div>
                  <div className="flex-1">
                    <p className="font-medium text-purple-800">Monthly attendance</p>
                    <p className="text-sm text-purple-600">{stats?.monthlyAttendance || 0}% this month</p>
                  </div>
                </div>
              </div>
            </CardContent>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card className="animate-slide-in-up card-glow">
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex justify-between items-center p-4 bg-orange-50 rounded-lg hover-scale">
                  <div>
                ...
                <div className="flex justify-between items-center p-4 bg-green-50 rounded-lg hover-scale">
                  <div>
                ...
                <div className="flex justify-between items-center p-4 bg-blue-50 rounded-lg hover-scale">
                  <div>
                    <p className="font-medium text-blue-800">Remaining Days</p>
                    <p className="text-sm text-blue-600">Available to use</p>
                  </div>
